    ...
    if(method==='get'){
      ...
      res.render('preIso')
       ...
       var tmpPath = req.files.file.path
        var targetPath = '/Users/liujun/coding/spm/public/uploads/iso.csv'
...
var lineNumber = 0;
var illNumber=0;
ndir.createLineReader('/Users/liujun/coding/spm/public/uploads/iso.csv').on('line', function(line) {
...
fs.appendFile('iso_error.txt',arr,'utf-8',function(err,data){
  ...
  fs.appendFile('/Users/liujun/coding/spm/public/converted/iso_con.csv',c,'utf-8',function(err,data){
    if(err)  
    {  
        console.log(err);  
    }  
...
//console.log(group+','+part)
  ...
  fs.appendFile('/Users/liujun/coding/spm/public/converted/iso_con.csv',b,'utf-8',function(err,data){
    if(err)  
    {  
        console.log(err);  
    }  
