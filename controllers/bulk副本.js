    ...
    if(method==='get'){
      ...
      console.log(req)
       var tmpPath = req.files.file.path
        ...
        var targetPath = '/Users/liujun/coding/spm/public/uploads/bulk.csv'
...
ndir.createLineReader('/Users/liujun/coding/spm/public/uploads/bulk.csv').on('line', function(line) {
...
//console.log(b)
  ...
  fs.appendFile('/Users/liujun/coding/spm/public/converted/bulk_con.csv',b,'utf-8',function(err,data){
    if(err)  
    {  
        console.log(err);  
    }  
